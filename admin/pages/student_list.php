...
<head>
  <meta charset="utf-8">
  <title>Import Students - student_list</title>
  ...
  <div class="w-full bg-white py-6">
    ...
    <form id="uploadForm" class="space-y-4">
      <div>
        ...
        <p id="error" class="text-red-500 text-sm hidden">Please choose a .xlsx file to upload.</p>
      </div>

      <div class="flex items-center gap-3">
        <button id="uploadBtn" type="button" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded">Upload & Import</button>
    ...
    $.ajax({
      ...
      success: function(resp){
        ...
        if (resp.success) {
          ...
          $('#result').html('<div class="p-4 bg-red-50 rounded border border-red-200"><p class="text-red-700 font-medium">' + resp.message + '</p></div>');
        }
      },
