  ...
  <div class="bg-white shadow p-6 mb-4">
    ...
    <form id="addVehicle" method="POST" class="space-y-4">
      ...
      <div>
        ...
        <input type="text" name="purpose" id="purpose" class="w-full px-4 py-2 border rounded-md" required readonly>
      </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.exists) {
                        ...
                        $("#plateStatus").html('<span style="color: red;">This plate number is not Registered.</span>');
