...
<body class="min-h-screen bg-gray-200 flex items-center justify-center p-2">
    <div class="bg-white shadow-lg rounded-xl p-8 w-full max-w-2xl">
        ...
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-center text-yellow-800 mb-4"> Vehicle Faculty Registration</h1>
            <p class="text-gray-600">
                Good day user! Ensure smooth and secure access by registering your vehicle in our system. 
            </p>
        </div>
        <div class="mt-4 mb-3">
        ...
        <form id="registrationForm" class="space-y-4">
            <div>
                ...
                <input type="text" id="student" name="entry_type" class="w-full border p-2 rounded hidden" value="Faculty">
